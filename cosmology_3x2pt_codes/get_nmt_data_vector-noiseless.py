...
shear={}
for ii in range(5):
    fname=savedir+f"deltamap{vd_tag}{nzonly_tag}-lens-tomo-{ii}-nside-512.fits"
    delta[ii] = hp.read_map(fname)
...
fname=savedir+f'data-noiseless-nmt-clgg{vd_tag}{nzonly_tag}-{nside}-binning-20-2000.txt'
...
fname=savedir+f'data-noiseless-nmt-clgk{vd_tag}{nzonly_tag}-{nside}-binning-20-2000.txt'
np.savetxt(fname,xcl)
print("Written: ", fname)
...
fname=savedir+f'data-nmt-clkk{vd_tag}-{nside}-binning-20-2000.txt'
np.savetxt(fname,xcl)
print("Written: ", fname)
"""