...
shear={}
for ii in range(5):
    fname=savedir+f"deltamap{vd_tag}-lens-tomo-{ii}-nside-512.fits"
...
for ii in range(5):
    ...
    fname = savedir+f"cov-noiseless-nmt-clgg-tomo-{ii}{vd_tag}-{nside}-binning-20-2000.txt"
...
for zz in range(5):
    ...
    for ll in range(5):
        if ll<=zz:
            ...
            fname=savedir+f'cov-noiseless-nmt-clgk-tomo-{zz}{ll}{vd_tag}-{nside}-binning-20-2000.txt'
...
for zz in range(5):
    ...
    for ll in range(5):
        ...
        if ll<=zz:
            ...
            fname=savedir+f'cov-nmt-clkk-tomo-{zz}{ll}{vd_tag}-{nside}-binning-20-2000.txt'
